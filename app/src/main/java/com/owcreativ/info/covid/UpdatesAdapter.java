...
public class UpdatesAdapter extends RecyclerView.Adapter<UpdatesAdapter.RvViewHolder>{
    Context context;
    ArrayList<NewsData> newsData;
    public UpdatesAdapter(Context context, ArrayList<NewsData> newsData){
    ...
    public RvViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = inflater.from(parent.getContext()).inflate(R.layout.news,parent,false);
