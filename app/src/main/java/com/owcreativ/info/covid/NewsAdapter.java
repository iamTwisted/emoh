...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.RvViewHolder>{
    Context context;
    ...
    public RvViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = inflater.from(parent.getContext()).inflate(R.layout.news_layout,parent,false);
