...
public class FactsActivity extends AppCompatActivity implements MythsAdapter.ContactsAdapterListener {

    private static final String TAG = FactsActivity.class.getSimpleName();
    private RecyclerView recyclerView;
    private List<Myths> contactList;
    private MythsAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* Toolbar toolbarTop = (Toolbar) findViewById(R.id.toolbar_top);
        ...
        Typeface typeface = ResourcesCompat.getFont(FactsActivity.this, R.font.wandery);
        // toolbar fancy stuff
        /*getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Symptoms");*/

        Toolbar myToolbar = (Toolbar) findViewById(R.id.toolbar);
        myToolbar.setTitle("Facts & Myths on 'Coronavirus'");
        ...
        mAdapter = new MythsAdapter(this, contactList, this);
    ...
    private void fetchContacts() {
        JsonArrayRequest request = new JsonArrayRequest(URLs.GET_MYTHS,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        List<Myths> items = new Gson().fromJson(response.toString(), new TypeToken<List<Myths>>() {
                        }.getType());
    ...
    @Override
    public void onContactSelected(Myths contact) {
