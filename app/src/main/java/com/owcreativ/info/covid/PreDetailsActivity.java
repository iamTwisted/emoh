...
public class PreDetailsActivity extends AppCompatActivity {
    ...
    private void getPrecautionsInfo(String id){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URLs.GET_PRECAUTIONS_DETAILS+id,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            JSONArray dataArray = jsonObject.getJSONArray("precautions");
                            for (int i = 0; i < dataArray.length(); i++) {
                                ...
                                Glide.with(PreDetailsActivity.this)
                                        .load(image)
