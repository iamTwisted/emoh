...
public class PreAdapter extends RecyclerView.Adapter<PreAdapter.HeroViewHolder> {
    ...
    public PreAdapter(List<PreData> preDataList, Context context) {
    ...
    public void onBindViewHolder(final HeroViewHolder holder, final int position) {
        ...
        holder.tvTitle.setText(preData.getTitle());
        holder.tvDescription.setText(preData.getDescription());
        holder.tvCategory.setText(preData.getCategory());
